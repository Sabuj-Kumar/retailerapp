...
class RetailerRegistration extends StatefulWidget {
  const RetailerRegistration({Key? key}) : super(key: key);

  @override
  _RetailerRegistrationState createState() => _RetailerRegistrationState();
}

class _RetailerRegistrationState extends State<RetailerRegistration> {
